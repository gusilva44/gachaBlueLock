const destaques = [
  {
    imagem: "/images/users-solid-full (1).svg",
    classe: "users",
    numero: "300",
    titulo: "JOGADORES",
  ...
  {
    imagem: "/images/trophy-solid-full.svg",
    classe: "troféu",
    numero: "1",
    titulo: "VENCEDOR",
  ...
  {
    imagem: "https://em-content.zobj.net/source/noto-emoji/445/stadium_1f3df-fe0f.png",
    classe: "",
    numero: "5",
    titulo: "LIGAS",
  ...
  {
    imagem: "/images/earth-asia-solid-full.svg",
    classe: "",
    numero: "11",
