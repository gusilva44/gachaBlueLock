const cards = [
  {
    chave: "kaiser",
    imagem: "/images/Kaiser pro site.jpeg",
    pais: "GERMANY",
    infoClasse: "info4",
    estilo: "GENIAL",
  ...
  {
    chave: "sae",
    imagem: "/images/Sae pro site.jpeg",
    pais: "JAPAN",
    infoClasse: "info5",
    estilo: "INTELIGENTE",
  ...
  {
    chave: "lorenzo",
    imagem: "/images/Lorenzo pro site.jpeg",
    pais: "ITALY",
    infoClasse: "info",
    estilo: "IMPREVISÍVEL",
    arma: "CRIATIVIDADE",
  ...
  {
    chave: "hugo",
    imagem: "/images/Hugo pro site.jpeg",
    pais: "FRANCE",
    infoClasse: "info1",
    estilo: "TÁTICO",
  ...
  {
    chave: "loki",
    imagem: "/images/Loki pro site.jpeg",
    pais: "FRANCE",
    infoClasse: "info2",
    estilo: "POTÊNCIA",
  ...
  {
    chave: "bunny",
    imagem: "/images/Bunny pro site.jpeg",
    pais: "SPAIN",
    infoClasse: "info3",
    estilo: "TÉCNICO",
